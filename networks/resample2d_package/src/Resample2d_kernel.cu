...
void Resample2d_kernel_forward(THCState* state, THCudaTensor* input1, THCudaTensor* input2, THCudaTensor* output, int kernel_size) {
    ...
    const long4 input2_size = make_long4(THCudaTensor_size(state,input2,0),THCudaTensor_size(state,input2,1),THCudaTensor_size(state,input2,2),THCudaTensor_size(state,input2,3));
    //const long4 input2_stride = make_long4(input2->stride[0], input2->stride[1], input2->stride[2], input2->stride[3]);
    const long4 input2_stride = make_long4(THCudaTensor_stride(state,input2,0), THCudaTensor_stride(state,input2,1), THCudaTensor_stride(state,input2,2),THCudaTensor_stride(state,input2,3));
...
void Resample2d_kernel_backward(THCState* state, THCudaTensor* input1, THCudaTensor* input2, THCudaTensor* gradOutput, THCudaTensor* gradInput1, THCudaTensor* gradInput2, int kernel_size) {
    ...
    const long4 gradInput2_size = make_long4(THCudaTensor_size(state,gradInput2,0),THCudaTensor_size(state,gradInput2,1),THCudaTensor_size(state,gradInput2,2),THCudaTensor_size(state,gradInput2,3));
    //const long4 gradInput2_stride = make_long4(gradInput2->stride[0], gradInput2->stride[1], gradInput2->stride[2], gradInput2->stride[3]);
    const long4 gradInput2_stride = make_long4(THCudaTensor_stride(state,gradInput2,0),THCudaTensor_stride(state,gradInput2,1),THCudaTensor_stride(state,gradInput2,2),THCudaTensor_stride(state,gradInput2,3));
